...
// Это необходимо было добавить, потому как иначе самописные автотесты не проходят в репе
// по-хорошему это генерируется из go.gen, а генерируемый код в репу не кладут
